...
static char causeCode[10] = {0};
static char causeText[100] = {0};
static char *xmlResult = NULL;
static const int MAX_ITEM = 5;

/** Mock invoke api backend **/
static size_t write_callback(void *contents, size_t size, size_t nmemb, void *userp);
static apt_bool_t mock_invoke_api(mrcp_engine_channel_t *channel, mrcp_message_t *request, mrcp_message_t *response);
static apt_bool_t mock_invoke_api_old(void);
...
static apt_bool_t mock_recog_channel_recognize(mrcp_engine_channel_t *channel, mrcp_message_t *request, mrcp_message_t *response) {
    ...
    /* test MOCK api*/
    (void)mock_invoke_api(channel, request, response);
...
static apt_bool_t mock_recog_result_load_v2(mock_recog_channel_t *recog_channel, mrcp_message_t *message) {
    mrcp_engine_channel_t *channel = recog_channel->channel;
    const apt_dir_layout_t *dir_layout = channel->engine->dir_layout;
    ...
    if (response_data.memory) {
        mrcp_generic_header_t *generic_header;
        char text[4096];
        apr_size_t size = (apr_size_t)strlen(xmlResult);
        sprintf(text, "%s\0", xmlResult);
...
static apt_bool_t mock_recog_recognition_complete(mock_recog_channel_t *recog_channel, mrcp_recog_completion_cause_e cause) {
    ...
    if (recog_header) {
        ...
        newCause = atoi(causeCode);
        recog_header->completion_cause = (mrcp_recog_completion_cause_e)newCause; // cause;
        mrcp_resource_header_property_add(message, RECOGNIZER_HEADER_COMPLETION_CAUSE);
    }
    /* set request state */
    message->start_line.request_state = MRCP_REQUEST_STATE_COMPLETE;

    if ((mrcp_recog_completion_cause_e)newCause == RECOGNIZER_COMPLETION_CAUSE_SUCCESS) {
        apt_bool_t ok = mock_recog_result_load_v2(recog_channel, message);
        if (!ok) {
            // fallback to old result
 ...
 "data": [
   {
     "index": 1,
     "mrcpCauseCode": "000",
     "mrcpCauseName": "success",
     "xml": "\u003C?xml version='1.0'?\u003E\u003Cresult\u003E\u003Cinterpretation grammar=\"http://127.0.0.1:90/gmmr/ami_prepaid/Ami_civr.gram?&amp;&amp;&amp;&amp;uniqueid=1730445795.4379&amp;#&amp;\" confidence=\"0.72\"\u003E\u003Cinput mode=\"speech\"\u003Eแพ็กเกจเวิดดิ่ง\u003C/input\u003E\u003Cinstance\u003E\u003Capp_tag_intent confidence=\"1\"\u003Etag-general_wordpk\u003C/app_tag_intent\u003E\u003CSWI_meaning\u003E{app_tag_intent:tag-general_wordpk}\u003C/SWI_meaning\u003E\u003CSWI_ssmMeanings\u003E\u003Capp_tag_intent\u003Etag-general_wordpk\u003C/app_tag_intent\u003E\u003C/SWI_ssmMeanings\u003E\u003CSWI_ssmConfidences\u003E\u003Capp_tag_intent\u003E100\u003C/app_tag_intent\u003E\u003C/SWI_ssmConfidences\u003E\u003CSWI_vars\u003E\u003C/SWI_vars\u003E\u003CBUILD confidence=\"0.72\"\u003E20241029200427\u003C/BUILD\u003E\u003C/instance\u003E\u003C/interpretation\u003E\u003C/result\u003E"
   },
   {
     "index": 2,
     "mrcpCauseCode": "000",
     "mrcpCauseName": "success",
     "xml": "\u003C?xml version='1.0'?\u003E\u003Cresult\u003E\u003Cinterpretation grammar=\"http://127.0.0.1:90/gmmr/ami_prepaid/Ami-sub_package_type.gram?&amp;&amp;&amp;&amp;uniqueid=1730445795.4379&amp;#&amp;\" confidence=\"0.96\"\u003E\u003Cinput mode=\"speech\"\u003Eในประเทศ\u003C/input\u003E\u003Cinstance\u003E\u003Capp_tag_intent confidence=\"1\"\u003Etag-package_local\u003C/app_tag_intent\u003E\u003CSWI_meaning\u003E{app_tag_intent:tag-package_local}\u003C/SWI_meaning\u003E\u003CSWI_ssmMeanings\u003E\u003Capp_tag_intent\u003Etag-package_local\u003C/app_tag_intent\u003E\u003C/SWI_ssmMeanings\u003E\u003CSWI_ssmConfidences\u003E\u003Capp_tag_intent\u003E100\u003C/app_tag_intent\u003E\u003C/SWI_ssmConfidences\u003E\u003CSWI_vars\u003E\u003C/SWI_vars\u003E\u003CBUILD confidence=\"0.96\"\u003E20241025142643\u003C/BUILD\u003E\u003C/instance\u003E\u003C/interpretation\u003E\u003C/result\u003E"
   },
   {
     "index": 3,
     "mrcpCauseCode": "000",
     "mrcpCauseName": "success",
     "xml": "\u003C?xml version='1.0'?\u003E\u003Cresult\u003E\u003Cinterpretation grammar=\"http://127.0.0.1:90/gmmr/ami_prepaid/Ami_civr.gram?&amp;&amp;&amp;&amp;uniqueid=1730445795.4379&amp;#&amp;\" confidence=\"0.01\"\u003E\u003Cinput mode=\"speech\"\u003Eแพ็กเกจเติมเงิน\u003C/input\u003E\u003Cinstance\u003E\u003Capp_tag_intent confidence=\"0.99\"\u003Etag-main_package\u003C/app_tag_intent\u003E\u003CSWI_meaning\u003E{app_tag_intent:tag-main_package}\u003C/SWI_meaning\u003E\u003CSWI_ssmMeanings\u003E\u003Capp_tag_intent\u003Etag-main_package\u003C/app_tag_intent\u003E\u003C/SWI_ssmMeanings\u003E\u003CSWI_ssmConfidences\u003E\u003Capp_tag_intent\u003E99\u003C/app_tag_intent\u003E\u003C/SWI_ssmConfidences\u003E\u003CSWI_vars\u003E\u003C/SWI_vars\u003E\u003CBUILD confidence=\"0.01\"\u003E20241029200427\u003C/BUILD\u003E\u003C/instance\u003E\u003C/interpretation\u003E\u003C/result\u003E"
   },
   {
     "index": 4,
     "mrcpCauseCode": "001",
     "mrcpCauseName": "no-match",
     "xml": ""
   },
   {
     "index": 5,
     "mrcpCauseCode": "002",
     "mrcpCauseName": "no-input-timeout",
     "xml": ""
   }
 ]
}
...
static apt_bool_t mock_invoke_api(mrcp_engine_channel_t *channel, mrcp_message_t *request, mrcp_message_t *response_msg) {
    CURL *curl;
    CURLcode res;
    ...
    const char *json_data = "{\"cmd\" : \"getmock\"}"; //"{\"incident_request\": {\"gen\": \"A\", \"lifestyle\": \"B\", \"partition\": \"Y\", \"language\": \"th\", \"va\": \"aunjaiVA\"}, \"name\": \"incident\", \"term\": \"getIncident\", \"vaName\": \"aunJaiVA\", \"language\": \"th\"}";
    const char *url = "https://sp.snapz.co/mrcp/index.php";
    if (curl) {
        apt_log(RECOG_LOG_MARK, APT_PRIO_INFO, "Invoke Mock API [%s]", url);
        ...
        if (res != CURLE_OK) {
            ...
            apt_log(RECOG_LOG_MARK, APT_PRIO_INFO, "Api Response: %s", response_data.memory);
        }
    ...
    if (response_data.memory) {
        ...
        if (!root) {
            ...
            json_t *testID = json_object_get(root, "testID");
            if (json_is_string(testID)) {
                apt_log(RECOG_LOG_MARK, APT_PRIO_INFO, "Process RECOGNIZE Request: %s", request->channel_id.session_id.buf);
                apt_log(RECOG_LOG_MARK, APT_PRIO_INFO, "testID: %s", json_string_value(testID));
            }

            json_t *data = json_object_get(root, "data");
            if (!json_is_array(data)) {
                apt_log(RECOG_LOG_MARK, APT_PRIO_INFO, "error: data is not an array");
                json_decref(root);
                return TRUE;
            }
            size_t index;
            json_t *value;
			length = json_array_size(data);
            json_array_foreach(data, index, value) {
                // Process each item in the array that match with current offset
                if (index == (offset)) {
                    json_t *index_obj = json_object_get(value, "index");
                    json_t *mrcpCauseCode = json_object_get(value, "mrcpCauseCode");
                    json_t *mrcpCauseName = json_object_get(value, "mrcpCauseName");
                    json_t *xml = json_object_get(value, "xml");
                    const char *xml_str = json_string_value(xml);
                    sprintf(causeCode, "%s\0", json_string_value(mrcpCauseCode));
                    sprintf(causeText, "%s\0", json_string_value(mrcpCauseName));

                    apt_log(RECOG_LOG_MARK, APT_PRIO_INFO, "Index: %d", (int)json_integer_value(index_obj));
                    apt_log(RECOG_LOG_MARK, APT_PRIO_INFO, "MRCP Cause Code: %s", causeCode);
                    apt_log(RECOG_LOG_MARK, APT_PRIO_INFO, "MRCP Cause Name: %s", causeText);

                    xmlResult = malloc(strlen(xml_str) + 1);
                    if (xmlResult) {
                        memset(xmlResult, 0, strlen(xml_str) + 1);
                        memcpy(xmlResult, xml_str, strlen(xml_str) + 1);
                        apt_log(RECOG_LOG_MARK, APT_PRIO_INFO, "XML: %s", xmlResult);
                    }
                    break;
                }
            }
...
static apt_bool_t mock_invoke_api_old(void) {
    ...
    /*
 {
    ...
    const chat *url = "https://functionappfilterrule.azurewebsites.net/api/incident";
    if (curl) {
    ...
    if (response_data.memory) {
        ...
        if (!root) {
            ...
            if (json_is_string(message) && json_is_string(message) && json_is_string(status) && json_is_string(version)) {
                apt_log(RECOG_LOG_MARK, APT_PRIO_INFO, "Status: %s", json_string_value(status));
                apt_log(RECOG_LOG_MARK, APT_PRIO_INFO, "DateTime: %s", json_string_value(dateTime));
                apt_log(RECOG_LOG_MARK, APT_PRIO_INFO, "Message: %s", json_string_value(message));
                apt_log(RECOG_LOG_MARK, APT_PRIO_INFO, "version: %s", json_string_value(version));
            }
